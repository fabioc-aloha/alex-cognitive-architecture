...
- **Blog posts [#8](https://github.com/fabioc-aloha/alex-cognitive-architecture/issues/8)-#11**: Four new posts with header images.
...
- **Blog [#7](https://github.com/fabioc-aloha/alex-cognitive-architecture/issues/7)**: "Every Age I'll Never Be" published with portrait gallery
...
- **Claude heirs removed**: Removed Claude Cowork (Gate [#17](https://github.com/fabioc-aloha/alex-cognitive-architecture/issues/17)) and Claude Chat (Gate [#18](https://github.com/fabioc-aloha/alex-cognitive-architecture/issues/18)) from roadmap -- Windows Agent subsumes this use case
...
- **Gate renumbering**: Windows Agent heir renumbered from [#19](https://github.com/fabioc-aloha/alex-cognitive-architecture/issues/19) to [#17](https://github.com/fabioc-aloha/alex-cognitive-architecture/issues/17)
...
- **Roadmap: blocked items fact-checked** — Contract B upgraded to "Partial" (`countTokens()` stable, 1.112 reserved-context visual); Gated [#13](https://github.com/fabioc-aloha/alex-cognitive-architecture/issues/13) (EmbeddedKnowledge) marked Done (shipped v6.2.0)
...
- **Extension audit report** — [alex_docs/audits/EXTENSION-AUDIT-2026-02-15.md](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/alex_docs/audits/EXTENSION-AUDIT-2026-02-15.md) with comprehensive code quality analysis
...
- Research-backed implementation from [appropriate-reliance article](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/article/appropriate-reliance/)
...
- **🛡️ Anti-Hallucination Skill** — New skill [#50](https://github.com/fabioc-aloha/alex-cognitive-architecture/issues/50)!
...
- **📋 Platform Comparison** — Full gap analysis with viability assessment
  ...
  - [PLATFORM-COMPARISON.md](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/alex_docs/PLATFORM-COMPARISON.md)

- **🎨 Image Generation ADR** — Design for VS Code parity
  - Azure OpenAI and OpenAI provider support
  - [ADR-007-image-generation.md](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/alex_docs/ADR-007-image-generation.md)
...
- **📚 Documentation**
  - [WORKSPACE-PROTECTION.md](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/alex_docs/WORKSPACE-PROTECTION.md) — Complete kill switch documentation
  - [COMEBACK-PLAN.md](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/alex_docs/archive/COMEBACK-PLAN.md) — Recovery roadmap
  - [ROADMAP-UNIFIED.md](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/ROADMAP-UNIFIED.md) — Single roadmap for all platforms
  - [RISKS.md](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/RISKS.md) — Risk register with contingency plans (updated with validation)
  - [EXTENSION-DEVELOPMENT-HOST.md](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/alex_docs/EXTENSION-DEVELOPMENT-HOST.md) — F5 testing guide
...
See [COMEBACK-PLAN.md](https://github.com/fabioc-aloha/alex-cognitive-architecture/blob/HEAD/alex_docs/archive/COMEBACK-PLAN.md) for details on what went wrong.
