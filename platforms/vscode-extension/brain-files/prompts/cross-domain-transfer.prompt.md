...
7. **Persist**: Create skill connections, GI-\* insights, or propose new trifecta links

## Connection Types

| Type                     | Signal                                                     | Output                                |
| ------------------------ | ---------------------------------------------------------- | ------------------------------------- |
| Technique transfer       | "This method from X solves Y's problem"                    | New connection between skills         |
