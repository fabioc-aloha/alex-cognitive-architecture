...
## Integration with Appropriate Reliance

This instruction extends `appropriate-reliance.instructions.md`:

- Appropriate reliance defines the confidence *levels* and *expression style*
