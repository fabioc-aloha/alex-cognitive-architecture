...
Always-active metacognitive monitoring. Consolidated from anti-hallucination, awareness, and appropriate-reliance.
...
- `.github/skills/anti-hallucination/SKILL.md` — red-flag detection, recovery
- `.github/skills/awareness/SKILL.md` — blind spots, epistemic vigilance
- `.github/skills/appropriate-reliance/SKILL.md` — confidence calibration, creative latitude
